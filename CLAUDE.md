...
Phases 0–4 of the roadmap below are done (not yet pushed — Phase 4 changes are local, ask before committing/pushing). Phase 5 (Pokémon detail page) is next.
